...
def print_rank_and_projector_gaps() -> None:
    ...
    print("This makes a rank-one adjacent overlap natural.")
    print("The incidence action is degenerate but symmetry-equivalent: all 21 unordered")
    print("Fano-line pairs have intersection rank one and form one automorphism orbit.")
    print("Given a rank-one transition kernel, the normalized log-cos action then")
    print("selects the primitive Weyl x primitive Jordan product by a -1/2 log(rank)")
    print("penalty; see compute/primitive_projector_derivation.py.")
    print()
