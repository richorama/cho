...
$\sin\phi=(d^2-3)/(d^2-1)$.  A dedicated search found no previous evaluation
of Eq.~\eqref{eq:defect} for either continuous family.
...
negative depolarizing boundary, and the SWAP endpoint.  The focused suite is
...
provides a controlled setting in which an optimal
