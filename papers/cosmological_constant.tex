...
No WIMP ($\sigma_{\chi N} = 0$) & LZ/XENONnT (running) & 
Null result at neutrino fog floor \\[3pt]
No SUSY ($\tilde{t}, \tilde{g}$) & HL-LHC (2029--35) & 
$m_{\\tilde{t}} > 2$~TeV, $m_{\\tilde{g}} > 3$~TeV \\[3pt]
...
\noindent Each row represents an independent test. Failure of \emph{any single 
row} would falsify the framework. Conversely, continued success across all 
channels would convert today's postdictions into a confirmed predictive 
programme without parallel in fundamental physics. The most imminent 
