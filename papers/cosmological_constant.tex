...
= 2.31~\text{meV},
\end{equation}
which is proposed to account for the 122-order-of-magnitude hierarchy through the algebraic 
structure of $\Alg = \Comp\otimes\Quat\otimes\Oct$. The bridge rests on 
