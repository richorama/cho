...
Twenty-Two Predictions with Zero Free Parameters}
...
action on a causal lattice, we derive twenty-two electroweak and flavour observables 
...
\midrule
\multicolumn{5}{c}{\textit{Total: 22 predictions, 0 free parameters}} \\
\bottomrule
\end{tabular}
