...
experimental $1\sigma$ uncertainty). Assigning conservative theory 
uncertainties of 1--3\% (the expected size of 1-loop corrections), the 
global $\chi^2/\text{dof} = 14.4/25 = 0.58$ ($p = 0.93$), with all 
individual pulls below $2\sigma$. The predictions are statistically 
better than what a random 0-parameter theory would produce by chance.
...
discrepancies are consistent with tree-level radiative corrections or 
